...
Межі таблиці в нарізаних смугах не дають працювати алгоритму, що поділяє показання на одиниці, функція delete_quadrilaterals їх видаляє. (Стовпці та рядки, що містять рівні чорні смуги завдовжки 15-20 % від довжини-ширини, вилучаються, зображення перезаписується.
